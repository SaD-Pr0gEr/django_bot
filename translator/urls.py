...
from translator.views import translate, delete_history, delete_word, delete_dict, add_dict, add_word_dict, \
    del_word_dict, add_new_word
...
urlpatterns = [
    ...
    path('add-new-word/', add_new_word, name='add_new_word'),
]
